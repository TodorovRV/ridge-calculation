...
def plot(contours=None, colors=None, vectors=None, vectors_values=None, x=None,
         y=None, blc=None, trc=None, cmap='plasma', abs_levels=None,
         ...
         colorbar_label=None, show=True, contour_color='k', P_colorcheme=False,
    ...
    if fig is None and axes is None:
        fig = plt.figure(figsize=(abs(round((y_[-1]-y[0])/(x_[-1]-x[0])))*6, 6))
    ...
    if contours is not None:
        ...
        if P_colorcheme:
            contour_colors = ['blue' for _ in range(n_max)]
            contour_colors[1] = 'black'
        else:
        ...
        co = ax.contour(y, x, contours[x_slice, y_slice], abs_levels,
                        colors=contour_colors, extent=extent,
